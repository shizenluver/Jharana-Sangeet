...
<div class="search-area">
    <div class="search-text">
      <h3 id="twentysingles">WATCH YOUR FAVOURITE VIDEOS</h3>
    </div>
...
<div class="videopage-bg">
    ...
    <!-- Featured video-->
    <div class="container videopage-video-margin">
        <div class="row-fluid">
            <div class="col-md-12">
            ...
            <div class="col-md-9 right-content">
                ...
                <div class="content-grids">
                    <div class="content-grid">
                        <a href="singlepage.html"><img src="images/thumb.png" title="allbum-name" /></a>
                        <h3>SONG TITLE</h3>
                        <ul>
