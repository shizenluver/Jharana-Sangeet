<!-- Footer starts-->
  <div class="footer-bg no-margin no-padding">
   <div class="container margin-top">
    ...
    <div class="row">
     <div class="col-md-6">
      <P><h3 id="div2" class="social-link-text">Get more updates on</h3></P>
     ...
     <div class="mail-text">
       <a href="mailto:jharanasangeetrecording@gmail.com">
         <span class="mail-text"><i class="fa fa-envelope-o"></i> @ jharanasangeetrecording@gmail.com</span></a><br>
       </div>
     </div>
