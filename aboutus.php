...
<body>
 ...
 <!-- Service section start -->
            ...
            <div class="section secondary-section">
                ...
                <div class="container">
                    <div class="title">
                        ...
                        <p>Words from our satisfied clients</p>
                    </div>
                    <div class="row">
                        <div class="span4">
        ...
        <div class="section third-section">
            <div class="container newsletter">
                ...
                <div id="success-subscribe" class="alert alert-success invisible">
                    <strong>Well done!</strong>You successfully subscribed to ourY</div>
                <div class="row-fluid">
                    <div class="span5">
                        <p>To get updated with us, subscribe us on our official youtube channel.</p>
                    </div>
                    <div class="span7">
        ...
        <div class="footer">
              <p>&copy; <?php echo date("Y");?> Jharana Sangeet Recording. All Rights Reserved.</p>
        </div>
        <!-- Footer section end -->
